...
public class HelloController {
    ...
    @FXML
    public void employessOnAction(ActionEvent actionEvent) {load("employee.fxml");}

    @FXML
    public void staffingOnAction(ActionEvent actionEvent) {load("staffAssignment.fxml");}
